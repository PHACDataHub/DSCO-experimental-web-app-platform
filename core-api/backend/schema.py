...
class Query(graphene.ObjectType):
    ...
    #################################################
    getAllRegions = graphene.List(CountryType, country_continent=graphene.String())
    ...
    #################################################
    getAllCountries = graphene.List(CountryType, country_region=graphene.String())
    ...
    getAllCountryLanguage = graphene.List(
        CountryLanguageType, countrylanguage_countrycode=graphene.String()
    )

    def resolve_getAllCountryLanguage(
        self, info, countrylanguage_countrycode, **kwargs
    ):
